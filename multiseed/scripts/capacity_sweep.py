import sys
#!/usr/bin/env python3
"""AUTO-GENERATED from capacity_sweep_GHZ_Mixed.ipynb.
...
SPARSITY = 0.1
METHODS = ['M1', 'M2']
M_M1 = 1023  # All non-identity Paulis for N=5 (informationally complete)
M_M2 = 40    # 40 bases * 32 outcomes = 1280 constraints > 1023 params
